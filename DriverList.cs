...
namespace DriverDatabase
{
	...
	class DriverList : OrigList
    {
		...
		{
			get { return Drivers[index]; }
			set { Drivers[index] = value; FireListChanged(); }
		}
		...
		public static readonly string DefaultFileName = @"drivers.xml";
	...
	class CarList : OrigList
    {
		...
		public Car this[int index]
		{
			...
			set	{ Cars[index] = value; FireListChanged(); }
		}
