...
namespace DriverDatabase
{
    public class CarForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BrandTextBox.Size = new System.Drawing.Size(124, 20);
        ...
        private void OKButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Car must have a name");
                return;
            }
            if (this.BrandTextBox.Text == "")
            {
                MessageBox.Show("Car must have a brand");
                return;
            }
            ...
            {
                MessageBox.Show("Choose at least 1 driver");
                return;
            }
            ResetDriverCars();
